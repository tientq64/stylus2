...
var stylus = function () {
	...
	require.register("functions/index.js", function (module, exports, require) {
		...
		exports.hsl2 = require("./hsl");
		exports.hsla2 = require("./hsla");
		...
		exports.rgb2 = require("./rgb");
		exports.rgba2 = require("./rgba");
		exports.s = require("./s");
	...
	require.register("functions/contrast.js", function (module, exports, require) {
		...
		module.exports = function contrast(top, bottom) {
			...
			function contrast(top, bottom) {
				...
				var l1 = luminosity(bottom).val + .05,
					l2 = luminosity(top).val + .05,
					ratio = l1 / l2;
				if (l2 > l1) {
					ratio = 1 / ratio;
				}
...
"undefined" != typeof module && (module.exports = stylus);
